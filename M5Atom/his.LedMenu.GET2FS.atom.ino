...
const char* urlData[] = {
  "http://192.168.0.115/GET2FS?menu=1&Color=\"Black\"",
  "http://192.168.0.115/GET2FS?menu=2&Color=\"Red\"",
  "http://192.168.0.115/GET2FS?menu=3&Color=\"Green\"",
  "http://192.168.0.115/GET2FS?menu=4&Color=\"Blue\"",
  "http://192.168.0.115/GET2FS?menu=5&Color=\"Yellow\"",
  "http://192.168.0.115/GET2FS?menu=6&Color=\"BlueGreen\"",
  "http://192.168.0.115/GET2FS?menu=7&Color=\"Pink\"",
  "http://192.168.0.115/GET2FS?menu=8&Color=\"White\""
};
